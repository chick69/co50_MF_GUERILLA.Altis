...
<br/>	* Domuk
<br/>
<br/><font size='16' color='#BBBBBB'>Modified By MF:</font>
<br/>	* Yannoukovytsh
<br/>	* Chick69
<br/>
...
"
<br/><font size='18'>Mercenaires-francais - A3Wasteland-GUERILLA</font>
<br/>
...
<br/>
<br/> Nous intervenons dans ce contexte, à la demande du président Slavaditsh et ce dans le plus grand secret en utilisant le couvert d'organisation non gouvernementale humanitaire
<br/> Il faut nous organiser afin de réunir suffisamment de moyen pour lutter les différentes factions présentes dans ce conflit
<br/>
...
<br/>
<br/> Vous vous retrouver dans le seul lieu isolé et sécurisé de l'ensemble de ce pays.
<br/> Vous avez pour démarrer cette aventure, un PA en .45 avec deux chargeurs, une ration alimentaire, une bouteille d'eau et un kit de réparation.
<br/> Votre salut passe par une coopération avec les autres memebres de votre groupe.
<br/> Essayer d'orgainsez seul une quelconque opération serait suicidaire.
<br/>
...
<br/>
<br/> Vous pouvez vous approprier certains véhicules, mais pas tous. (Véhicules des missions - non ).
...
<br/>
<br/> les admins sont présent pour vous aider ou pour vous chatier....
"
]];
